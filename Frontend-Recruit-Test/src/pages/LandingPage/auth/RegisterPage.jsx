  ...
  const handleSubmit = useCallback(
    async (e) => {
      ...
      try {
        ...
        // Create or find tenant by company name, then register with tenantId
        let tenantId;
        try {
          const tenantRes = await axiosInstance.post("/auth/tenant", {
            companyName: formData.companyName,
          });
          tenantId = tenantRes.data.tenantId;
        } catch (tenantErr) {
          // If tenant endpoint doesn't exist, use companyName as tenantId fallback
          tenantId = formData.companyName;
        }
      ...
      <form onSubmit={handleSubmit} className="space-y-4">
        ...
        <div>
          ...
          >
            ...
            <option value="BUSINESS_APPROVER">Business Approver</option>
